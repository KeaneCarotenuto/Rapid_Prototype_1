...
{
    public AudioSource m_Ambience, m_Announcements, m_SoundEffects;

    public AudioClip m_AmbientTrack, m_GameStart, m_ScoreScreen;
    ...
    void Start()
    {
        ...
        m_Ambience.PlayDelayed(m_GameStart.length);
